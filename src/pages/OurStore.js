                        ...
                        <div className="col-3">
                            ...
                            <div className='filter-card mb-3 '>
                                ...
                                <h5 className="sub-title">Avaliability</h5>
                                    ...
                                    <div className="form-check">
                                        <input type="checkbox"
                                            className="form-check-input" value="" id='' />
                       ...
                       <label htmlFor="floatingInput1">To</label>
                                ...
                                <div className="form-check">
                                        <input type="checkbox" value="" id='color-1'
                                            className="form-check-input" />
                                        <label  className="form-check-label" htmlFor="color-1">$(2)</label>
                                    </div>
                                </div>
                                 <div>
                                <div className="form-check">
                                ...
                                <div>
                                    <div className="random-product mb-3 d-flex">
                                        ...
                                        <div className="w-50">
                                          ...
                                          <ReactStars edit={false}  count={5} size={24} value={4} activeColor="#ffd700"/>
                                        <b>$300</b>
                                        </div>
                        ...
                        <div className="col-9">
                            <div className="filter-sort-grid mb-4">
                                ...
                                <div className="d-flex align-items-center gap-10">
                                    ...
                                    <img onClick={() =>{
                                        setGrid(3);
                                    }} src="images/gr4.svg" className='d-block img-fluid' alt="gird" />
                                        <img onClick={() =>{
                                            setGrid(4);
                                        }} src="images/gr3.svg" className='d-block img-fluid' alt="gird" />
                                            <img onClick={() =>{
                                                setGrid(6);
                                            }} src="images/gr2.svg" className='d-block img-fluid' alt="gird" />
                                        <img onClick={() =>{
                                            setGrid(12);
                                        }} src="images/gr.svg" className='d-block img-fluid' alt="gird" />
                                    </div>
                                  </div>
                                </div>
