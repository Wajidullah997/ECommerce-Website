...
const Header = () => {
  return (
    <>
      <header className="header-top-script py-3">
        <div className="container-xxl">
          <div className="row">
            <div className="col-6">
              <p className='text-white mb-0'>Free Shoping Over $100 & Free Retuerns</p>
            </div>
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Hotline: <a className='text-white' href="tel:+92 3450303902">+92 3450303902</a></p>
            </div>
          </div>
        </div>
      </header>
      ...
      <header className="header-uper py-3">
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-2">
              <h2>
                <Link className='text-white'>Dev Corner
                </Link>
              </h2>
            </div>
            <div className="col-5">
            ...
            <div className="col-5">
              <div className="header-upper-links d-flex align-items-center justify-content-between">
                ...
                <div><Link className='d-flex align-items-center gap-10'>
